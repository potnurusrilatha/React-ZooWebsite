...
let mammalEchidna = new Animals("Mammals", "Echidna", 50, ["insects such as ants and termites", "beetle larvae", "worms"],
    ...
    76, 10, "Throughout Austalia", "./images/Echidna.jpg", 'Mammals', './html/mammals.html','echidna.jpg','echidna.png');
...
let mammalquokka  = new Animals("Mammals", "Quokka", 10, ["Plant eaters", " shrubs", "grasses"],
    ...
    50, 3, "Rottnest Island,few places on mainland Western Australia",  "./images/quokka.jpg", 'Mammals', './html/mammals.html', 'quokka.jpg', 'quokka.png');
...
let reptileHawksbillTurtle = new Animals("Reptiles","Hawksbill Turtle", 50,["sponges", "jellyfish","seaplants"], 
    ...
    80,50,"Tropical coasts of Queensland, Northern Territory and Western Australia",  "./images/Hawksbill Turtle.jpg", 'Reptiles', './html/reptiles.html', 'Hawksbill Turtle.jpg', 'hawksbill-turtle.png');
...
let reptilePerentie  = new Animals("Reptiles","Perentie", 20,["Carnivore", "animals like kangaroos", "rabbits", "lizards and birds"], 
    ...
    250,20,"Desert",  "./images/perentie.jpg", 'Reptiles', './html/reptiles.html', 'perentie.jpg', 'perentie.png');
...
let birdCassowary = new Animals("Birds","Cassowary", 20,["Plants matter like fruit", "insects and small animals like mice amd lizards"], 
    ...
    117,44,"Queensland",  "./images/Cassowary.jpg", 'Birds', './html/birds.html', 'cassowary.jpg', 'cassowary.png');
...
let birdKookaburra = new Animals("Birds","Kookaburra", 20,["Insects and smalll animals including snakes", "frogs","lizards"], 
    ...
    43,0.003,"Throughout Austalia",  "./images/Kookaburra.jpg", 'Birds', './html/birds.html', 'kookaburra.jpg', 'kookaburra.png');
...
let birdYellowTailedBlackCockatoo = new Animals("Birds","Yellow Tailed Black Cockatoo", 41,["Fruit", "seeds","plant"], 
    ...
    65,0.9,"SE Austalia",  "./images/Yellow-tailedBlackCockatoos.jpg", 'Birds', './html/birds.html', 'yellow-tailed-black-cockatoo.jpg', 'yellowtailed.png');
